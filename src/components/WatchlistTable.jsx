          ...
          {rows.map((row) => (
            ...
            >
              <td className="max-w-[70px] py-2 pr-1 align-top sm:max-w-none">
                ...
                <div className="truncate text-[10px] text-[#94a3b8] sm:hidden" title={row.name || ''}>
                  {row.name || '—'}
                </div>
              </td>
              <td
                className="hidden max-w-[8rem] truncate py-2 pr-1 align-middle text-[#475569] sm:table-cell"
                title={row.name || ''}
              >
                {row.name || '—'}
              </td>
